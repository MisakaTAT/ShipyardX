...
export const commands = {
	...
	openContainerExecTerminal: (serverId: string, containerId: string, user: string | null, shell: string, cols: number, rows: number) => __TAURI_INVOKE<TerminalSession>("open_container_exec_terminal", { serverId, containerId, user, shell, cols, rows }),
